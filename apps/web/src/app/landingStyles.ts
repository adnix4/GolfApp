...
export const L: Record<string, CSSProperties> = {
  ...
  heroTag:   { color: 'var(--color-accent)', fontSize: '0.8rem', fontWeight: 600, textTransform: 'uppercase', letterSpacing: 1, marginBottom: '1rem' },
  ...
  ctaOutline:     { backgroundColor: 'transparent', color: 'var(--color-accent)', fontSize: '1rem', fontWeight: 700, padding: '0.9rem 1.75rem', borderRadius: 12, border: '1.5px solid var(--color-accent)', display: 'inline-block' },
  ...
  statLabel: { color: 'var(--color-accent)', fontSize: '0.75rem', fontWeight: 600, textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 2 },

  // ── Sections ───────────────────────────────────────────────────────────────
  section:      { padding: '3.5rem 0' },
  sectionTitle: { color: 'var(--color-primary)', fontSize: '1.9rem', fontWeight: 900, textAlign: 'center', marginBottom: '0.75rem' },
  sectionSub:   { color: 'var(--color-accent)', fontSize: '1rem', textAlign: 'center', lineHeight: 1.6, marginBottom: '2.5rem', maxWidth: 640, marginLeft: 'auto', marginRight: 'auto' },
  ...
  featureDesc: { color: 'var(--color-accent)', fontSize: '0.9rem', lineHeight: 1.5 },
  ...
  stepDesc:   { color: 'var(--color-accent)', fontSize: '0.92rem', lineHeight: 1.55 },
  ...
  footerText: { color: 'var(--color-accent)', fontSize: '0.82rem' },
